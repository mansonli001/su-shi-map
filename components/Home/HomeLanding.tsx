      ...
      <section className="ho-hero">
        ...
        >
          ...
          <polyline
            ...
            opacity="0.9"
          />
          <circle cx="12" cy="42" r="3" fill="var(--ho-accent)" opacity="0.9" />
          <circle cx="38" cy="30" r="2.5" fill="var(--ho-accent)" opacity="0.7" />
          <circle cx="68" cy="18" r="4" fill="var(--ho-accent)" />
          <circle cx="100" cy="30" r="3" fill="var(--ho-accent)" opacity="0.75" />
          <circle cx="132" cy="12" r="2.5" fill="var(--ho-accent)" opacity="0.6" />
          <circle cx="152" cy="36" r="3.5" fill="var(--ho-accent)" opacity="0.85" />
        </svg>

        <p className="ho-body">
          <span className="ho-body-line">一千年前，苏轼从眉山出发，</span>
          <span className="ho-body-line">走过了这片土地上的 234 个地方。</span>
        ...
        <div className="ho-em">跟着苏轼，走遍神州</div>
